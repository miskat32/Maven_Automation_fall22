...
public class Mouse_Actions_ups {
    public static void main(String[] args) throws InterruptedException {//setup chrome driver
        ...
        //click on look uo a Zip Code from the drop down
